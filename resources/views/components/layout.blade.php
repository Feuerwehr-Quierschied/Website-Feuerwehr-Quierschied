...
<head>
    ...
    @media (min-width:768px) {
        .abteilungen-chevron-desktop { transform: rotate(-180deg); transition: transform .15s ease; }
        .abteilungen-group:hover .abteilungen-chevron-desktop { transform: rotate(0deg); }
    ...
    <div class="max-w-7xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 md:flex-row md:space-x-8 md:mt-0">
                <li>
                    <a href="/" class="block py-2 px-3 text-fire-red hover:text-blue-600  rounded md:bg-transparent  md:p-0 active" aria-current="page">Home</a>
                </li>
                ...
                <li class="relative group dropdown-container">
                    <div class="flex items-center justify-between text-def-text hover:text-white w-full md:inline-flex md:justify-start">
                        ...
                        <svg class="hidden md:inline-block w-2.5 h-2.5 ms-2.5 transition-transform md:group-hover:rotate-180" fill="none" viewBox="0 0 10 6">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                        </svg>
                    </div>
                            ...
                            <li class="relative abteilungen-group">
                                <div class="flex items-center justify-between hover:bg-gray-700 hover:text-fire-red w-full md:inline-flex md:justify-start">
                                    ...
                                    <button type="button" class="abteilungen-chevron p-2 md:hidden">
                                        <svg class="w-3 h-3 transition-transform duration-150" fill="none" viewBox="0 0 10 10">
                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2 3l3 3 3-3"/>
                                        </svg>
                                    </button>
                                    <svg class="abteilungen-chevron-desktop hidden md:inline-block w-3 h-3 ms-2 transition-transform duration-150 rotate-180 md:group-hover:rotate-0" fill="none" viewBox="0 0 10 10">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2 3l3 3 3-3"/>
                                    </svg>
                                </div>
